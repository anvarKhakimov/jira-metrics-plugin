...
import { TableCell, TableRow, IconButton, Collapse, Box, Typography } from '@mui/material';
...
function Row({ taskKey, task, cfdData, selectedColumns, index, dateFormat }) {
  ...
  return (
    <>
      <TableRow sx={{ '& > *': { borderBottom: 'unset' }, bgcolor: rowColor }}>
        ...
        <TableCell align="right">{durationToReadableFormat(task.leadTime, dateFormat)}</TableCell>
